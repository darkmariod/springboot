...
class Product extends Model {
    protected $fillable = ['company_id','codigo','descripcion','tipo','imagen','precio','tarifa_iva','stock','costo_promedio','maneja_series','stock_minimo','stock_maximo','ubicacion','es_combo'];
